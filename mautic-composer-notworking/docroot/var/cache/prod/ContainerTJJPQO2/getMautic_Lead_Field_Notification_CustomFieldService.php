...
class getMautic_Lead_Field_Notification_CustomFieldService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['mautic.lead.field.notification.custom_field'] = new \Mautic\LeadBundle\Field\Notification\CustomFieldNotification(($container->services['Mautic\\CoreBundle\\Model\\NotificationModel'] ?? $container->getNotificationModelService()), ($container->services['Mautic\\UserBundle\\Model\\UserModel'] ?? $container->getUserModelService()), ($container->services['translator'] ?? $container->getTranslator2Service()));
    }
}
