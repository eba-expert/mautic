 ...
 */
class getSecurity_Authentication_Listener_Rememberme_MainService extends AppKernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['security.authentication.listener.rememberme.main'])) {
            return $container->privates['security.authentication.listener.rememberme.main'];
        }
