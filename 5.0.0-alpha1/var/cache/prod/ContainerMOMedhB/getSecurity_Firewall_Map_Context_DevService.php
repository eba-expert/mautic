 ...
 */
class getSecurity_Firewall_Map_Context_DevService extends AppKernelProdContainer
{
    /*
    ...
    {
        return $container->privates['security.firewall.map.context.dev'] = new \Symfony\Bundle\SecurityBundle\Security\LazyFirewallContext(new RewindableGenerator(function () use ($container) {
