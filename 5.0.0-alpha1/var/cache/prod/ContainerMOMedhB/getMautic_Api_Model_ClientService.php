 ...
 */
class getMautic_Api_Model_ClientService extends AppKernelProdContainer
{
    /*
     * Gets the public 'mautic.api.model.client' shared service.
     *
     * @return \Mautic\ApiBundle\Model\ClientModel
     */
    public static function do($container, $lazyLoad = true)
    {
        $container->services['mautic.api.model.client'] = $instance = new \Mautic\ApiBundle\Model\ClientModel(($container->services['request_stack'] ?? ($container->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())));
