 ...
 */
class getMautic_Page_Model_VideoService extends AppKernelProdContainer
{
    /*
     * Gets the public 'mautic.page.model.video' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->services['mautic.page.model.video'])) {
            return $container->services['mautic.page.model.video'];
        }

        $container->services['mautic.page.model.video'] = $instance = new \Mautic\PageBundle\Model\VideoModel(($container->services['mautic.helper.ip_lookup'] ?? $container->getMautic_Helper_IpLookupService()), $a);
