...
class getConsole_Command_MessengerSetupTransportsService extends AppKernelProdContainer
{
    ...
    {
        $container->privates['console.command.messenger_setup_transports'] = $instance = new \Symfony\Component\Messenger\Command\SetupTransportsCommand(($container->privates['messenger.receiver_locator'] ?? $container->load('getMessenger_ReceiverLocatorService')), [0 => 'email_transport', 1 => 'failed_default']);
