...
class getMautic_Lead_Field_Settings_BackgroundServiceService extends AppKernelProdContainer
{
    ...
    {
        return $container->services['mautic.lead.field.settings.background_service'] = new \Mautic\LeadBundle\Field\BackgroundService(($container->services['mautic.lead.model.field'] ?? $container->getMautic_Lead_Model_FieldService()), ($container->services['mautic.lead.field.custom_field_column'] ?? $container->getMautic_Lead_Field_CustomFieldColumnService()), ($container->services['mautic.lead.field.lead_field_saver'] ?? $container->getMautic_Lead_Field_LeadFieldSaverService()), ($container->services['mautic.lead.field.dispatcher.field_column_background_dispatcher'] ?? $container->load('getMautic_Lead_Field_Dispatcher_FieldColumnBackgroundDispatcherService')), ($container->services['mautic.lead.field.notification.custom_field'] ?? $container->load('getMautic_Lead_Field_Notification_CustomFieldService')));
    }
}
