 ...
 */
class getMautic_Campaign_Model_SummaryService extends AppKernelProdContainer
{
    /*
     * Gets the public 'mautic.campaign.model.summary' shared service.
     *
     * @return \Mautic\CampaignBundle\Model\SummaryModel
     */
    public static function do($container, $lazyLoad = true)
    {
        $container->services['mautic.campaign.model.summary'] = $instance = new \Mautic\CampaignBundle\Model\SummaryModel(($container->services['mautic.campaign.repository.lead_event_log'] ?? $container->getMautic_Campaign_Repository_LeadEventLogService()));
