 ...
 */
class getGrapesjsbuilder_ModelService extends AppKernelProdContainer
{
    /*
     * Gets the public 'grapesjsbuilder.model' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->services['grapesjsbuilder.model'])) {
            return $container->services['grapesjsbuilder.model'];
        }

        $container->services['grapesjsbuilder.model'] = $instance = new \MauticPlugin\GrapesJsBuilderBundle\Model\GrapesJsBuilderModel(($container->services['request_stack'] ?? ($container->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), $a);
