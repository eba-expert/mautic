 ...
 */
class getMautic_DynamicContent_Model_DynamicContentService extends AppKernelProdContainer
{
    /*
     * Gets the public 'mautic.dynamicContent.model.dynamicContent' shared service.
     *
     * @return \Mautic\DynamicContentBundle\Model\DynamicContentModel
     */
    public static function do($container, $lazyLoad = true)
    {
        $container->services['mautic.dynamicContent.model.dynamicContent'] = $instance = new \Mautic\DynamicContentBundle\Model\DynamicContentModel();
