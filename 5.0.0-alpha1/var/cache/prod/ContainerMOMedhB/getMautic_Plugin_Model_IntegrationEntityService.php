 ...
 */
class getMautic_Plugin_Model_IntegrationEntityService extends AppKernelProdContainer
{
    /*
     * Gets the public 'mautic.plugin.model.integration_entity' shared service.
     *
     * @return \Mautic\PluginBundle\Model\IntegrationEntityModel
     */
    public static function do($container, $lazyLoad = true)
    {
        $container->services['mautic.plugin.model.integration_entity'] = $instance = new \Mautic\PluginBundle\Model\IntegrationEntityModel();
