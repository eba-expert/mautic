...
class getMessenger_Middleware_SendMessageService extends AppKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['messenger.middleware.send_message'] = $instance = new \Symfony\Component\Messenger\Middleware\SendMessageMiddleware(new \Symfony\Component\Messenger\Transport\Sender\SendersLocator(['Symfony\\Component\\Mailer\\Messenger\\SendEmailMessage' => [0 => 'email'], 'Mautic\\MessengerBundle\\Message\\TestEmail' => [0 => 'email'], 'Mautic\\MessengerBundle\\Message\\TestFailed' => [0 => 'failed']], $a), $b);
