...
class getMautic_Campaign_LegacyEventDispatcherService extends AppKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $d = ($container->services['Mautic\\CoreBundle\\Factory\\MauticFactory'] ?? $container->getMauticFactoryService());

        if (isset($container->services['mautic.campaign.legacy_event_dispatcher'])) {
            return $container->services['mautic.campaign.legacy_event_dispatcher'];
        }
        $e = ($container->services['mautic.tracker.contact'] ?? $container->getMautic_Tracker_ContactService());

        if (isset($container->services['mautic.campaign.legacy_event_dispatcher'])) {
            return $container->services['mautic.campaign.legacy_event_dispatcher'];
        }

        return $container->services['mautic.campaign.legacy_event_dispatcher'] = new \Mautic\CampaignBundle\Executioner\Dispatcher\LegacyEventDispatcher($a, $b, ($container->services['monolog.logger.mautic'] ?? $container->getMonolog_Logger_MauticService()), $c, $d, $e);
    }
}
