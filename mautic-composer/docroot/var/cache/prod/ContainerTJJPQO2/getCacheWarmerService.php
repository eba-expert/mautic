 ...
 */
class getCacheWarmerService extends AppKernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        return $container->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(new RewindableGenerator(function () use ($container) {
            ...
            yield 9 => ($container->services['mautic.cache.warmer.middleware'] ?? ($container->services['mautic.cache.warmer.middleware'] = new \Mautic\CoreBundle\Cache\MiddlewareCacheWarmer('prod')));
        }, 10), false, ($container->targetDir.''.'/AppKernelProdContainerDeprecations.log'));
    }
}
